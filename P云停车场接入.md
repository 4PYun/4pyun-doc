...
| version| string | Y | 版本号:`1.0`|
| charset| string | Y | 字符集:`UTF-8`|
|result_code | string | Y | 状态码:<br/>值 含义<br/>1001  订单获取成功, 业务参数将返回.<br/>1002  未查询到停车信息.<br/>1003  固定车辆, 不允许支付(有效期内返回, 过期不返回此状态).<br/>1401  签名错误, 请检查配置.<br/>1500  接口处理异常, 例如无牌车获取订单没有车辆等. |
...
| expire_time | string | Y | 指定券失效时间, 格式: `yyyyMMddHHmmss` |
