...
2021-05-13 固定车可返回最大续费限制时间可限制时间类固定车最大续费截止日期。
```
...
- 当前是没有没有车辆，传入`passport`, 并且`passport`有停车中记录提示没有检测到无牌车, 防止系统自动清理无牌车状态（result_code=1500;
